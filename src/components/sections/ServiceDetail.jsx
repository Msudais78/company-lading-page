  ...
  return (
    <article className="min-h-screen bg-primary-bg">
      ...
      <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <a href="/" className="inline-flex items-center gap-2 text-primary-faint hover:text-primary-text font-bold uppercase tracking-widest text-xs mb-12 transition-colors">
